          ...
          {step === 1 && (
            <div>
              ...
              <div className="flex items-center justify-between gap-20">
                <Link href="/dashboard" className="max-w-max flex items-center justify-center rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#008751] text-white">
                  Cancel
                </Link>
                <button type="button" className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#008751] text-white" onClick={handleNext}>
                  Next
                </button>
              </div>
            </div>
            ...
            <div>
              <div className="mb-3">
                ...
                <div className="flex gap-2 mt-2">
                  <div className="rounded-lg flex items-center justify-center w-[35px] h-[35px] bg-[#008751] text-white">WF</div>
                  <div className="flex flex-col gap-1">
                    <span className="uppercase">
                      {user.holder.firstName} {user.holder.lastName}
                    </span>
                    <span className="text-sm text-[#303030]">Available Balance: {formatCurrency(user.bank_details.balance_usd)}</span>
                  </div>
                </div>
              </div>
          ...
          {step === 3 && (
            <div>
              ...
              <div className="flex items-center justify-between gap-20">
                ...
                <button type="submit" className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#008751] text-white">
